...
// Store at compass in computer memory : -  
    ...
    try{
        ...
        if(!existingUser) {
            const registrationData = new registration({
                ...
                console.log("Successfully Save Details.....")
...
app.get("/success", (req, res)=>{
    res.sendFile ("newRegistration\pages\success.html");
})
app.get("/error", (req, res)=>{
    res.sendFile ("newRegistration\pages\erroe.html");
})
app.listen(port, ()=>{
